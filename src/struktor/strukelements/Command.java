...
{
	/** StandardmÑòig auf CALCULATION (Verarbeitung) */
	private int action = CALCULATION;
	
	/** Die AdditionalMessage (FÅr INPUT/OUTPUT*/
	...
	/** Setter-Methode
	 * Die H˜he des Elements verÑndern (Spezialfall wegen Input/Output)
	 * @param   height  
	 */
	...
	private String producePrintf()
	{
		...
		// mit dieser Schleife gehen wir das komplette Label char fÅr char durch
